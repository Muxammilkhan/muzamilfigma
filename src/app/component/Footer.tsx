...
const Footer: FC = () => {
  return (
    <footer className="bg-white border-t border-gray-200 ml-12 " >
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {/* Logo and About */}
        <div className="w-full sm:w-[350px]">
          <h2 className="flex items-center space-x-2 text-xl font-semibold text-gray-800 ml-12 ">
            <Image
          ...
          <p className="mt-4 text-sm text-gray-600 leading-relaxed ml-12 ">
          ...
          <div className="flex space-x-4 mt-6 ml-12 ">
            {/* Social Media Icons */}
            <Link
              href="#"
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2 ml-12  ">
            {[
              "Sofa",
              "Armchair",
              "Wing Chair",
