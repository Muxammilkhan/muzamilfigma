    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-8">
          <p className="mt-1 text-lg font-medium  md:text-base lg:text-lg">
            WELCOME TO CHIRAY
          </p>
      ...
      <section className="container mx-auto px-4 py-16 ml-12">
      ...
      <section className="container mx-auto px-4 py-16 ">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 ml-12">
