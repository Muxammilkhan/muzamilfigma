          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ml-12 ">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-1xl font-semibold ">Address</h1>
                ...
                <p className="text-lg font-medium">236 5th SE Avenue, New<br/>York Ny10000, United<br/>States  </p>
              </div>
              <div>
                <h2 className="text-1xl font-semibold">Phone</h2>
                <p className="text-lg font-medium">
                  Mobile: (+92) 3123456789<br />
                  Hotline: (+92) 32456789
                </p>
              </div>
              <div>
                <h2 className="text-1xl font-semibold">Working Time</h2>
                <p className="text-lg font-medium">
            ...
            <form className=" p-6 space-y-10">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  placeholder="muzamilqureshi@gmail.com"
                  className="w-[450] mt-1 px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-teal-500 focus:border-teal-500"
                  required
                />
              </div>
